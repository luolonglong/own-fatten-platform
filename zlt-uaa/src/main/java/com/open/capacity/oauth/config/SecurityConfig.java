package com.open.capacity.oauth.config;

import com.open.capacity.common.constant.SecurityConstants;
import com.open.capacity.common.properties.TenantProperties;
import com.open.capacity.oauth.filter.LoginProcessSetTenantFilter;
import com.open.capacity.oauth.password.PasswordAuthenticationProvider;
import com.open.capacity.oauth.service.impl.UserDetailServiceFactory;
import com.open.capacity.oauth.tenant.TenantAuthenticationSecurityConfig;
import com.open.capacity.oauth.tenant.TenantUsernamePasswordAuthenticationFilter;
import com.open.capacity.oauth.mobile.MobileAuthenticationSecurityConfig;
import com.open.capacity.oauth.openid.OpenIdAuthenticationSecurityConfig;
import com.open.capacity.common.config.DefaultPasswordConfig;
import com.open.capacity.oauth2.common.token.CustomWebAuthenticationDetails;
